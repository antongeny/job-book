...
const seed = async () => {
  ...
  const [user] = await Promise.all([
    User.create({ username: "user", password: "123123", email:"user123@gmail.com" }),
  ...
  // bob.addPeople([personOne, personTwo]);
  // bob.addCompanies([companyOne, companyTwo]);
  // bob.addJobApplication(applicationOne);
